...
import me.badbones69.blockparticles.multisupport.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	public static abstract class ParticleData {
		 ...
		 */
		@SuppressWarnings("deprecation") ParticleData(Material material, byte data) {
		...
		static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				if(version > 7 && version < 13)
					...
					enumParticle = PackageType.MINECRAFT_SERVER.getClass("ParticleParam");
