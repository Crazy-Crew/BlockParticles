...
public class Categories {
    ...
    private Map<String, List<String>> heads = new ConcurrentHashMap<>();

    public Categories populate() {
        this.heads.put("pokemon", List.of(
        ...
        this.heads.put("presents", List.of(
