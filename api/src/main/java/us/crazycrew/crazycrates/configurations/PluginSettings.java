...
public class PluginSettings implements SettingsHolder {
    ...
    public static final Property<String> COMMAND_PERMISSION = newProperty("settings.permission", "crazyparticles");

    @Comment("The command prefix that is shown at the beginning of every message.")
    public static final Property<String> COMMAND_PREFIX = newProperty("settings.prefix.command", "<red>[</red><green>CrazyParticles</green><red>]</green> ");

    @Comment("The prefix that is shown for messages sent in console such as logging messages.")
    public static final Property<String> CONSOLE_PREFIX = newProperty("settings.prefix.console", "<gradient:#fe5f55:#6b55b5>[CrazyParticles]</gradient> ");
    ...
    @Comment({
            ...
            "https://github.com/Crazy-Crew/CrazyParticles/blob/main/platforms/paper/src/main/resources/locale/en-US.yml",
