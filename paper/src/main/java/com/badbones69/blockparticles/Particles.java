...
public class Particles implements ParticleControl {
    ...
    public void playVolcano(final Location location, String id) {
        locations.put(id, server.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
            ...
            public void run() {
                ...
                world.spawnParticle(Particle.LAVA, l, 10, 0, 0, 0, 0);
            }
        }, 0, 4));
    }
        ...
        locations.put(id, server.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    server.getScheduler().cancelTask(locations.get(id));
                    e.printStackTrace();
                }
            }
        }, 0, 2));
    ...
    public void playSoulWell(final Location location, final String id) {
        ...
        locations.put(id, server.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
            ...
            void startSoulWell(final Location location, final String id) {
                ...
                S.put(num, server.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
